        ...
        <div className={classes.root}>
            ...
            <Grid container direction="column" spacing={2}>
                ...
                <Grid item>
                    <List>
                        <ListItem>
                            <ListItemText primary="Créé le" secondary={<Moment>{data.creationDate}</Moment>} />
                            <ListItemText primary="Créé par" secondary={data.ownerNickname} />
                            <ListItemText primary="Déjà importé" secondary={data.imported} />
                            <ListItemText
