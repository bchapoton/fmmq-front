            ...
            <DialogContent>
                ...
                <Accordion>
                    ...
                    >
                        <Typography className={classes.expansionPanelHeading}>
                            J'ai Firefox (
                            <Link href="https://www.mozilla.org/fr/firefox/new/" target="_blank">
                                si je ne l'ai pas je devrais
                            </Link>
                            )
                        </Typography>
                    </AccordionSummary>
                    <AccordionDetails className={classes.expansionPanelDetails}>
                        <div>
                            Dans la barre d'adresse mettre le paramètre <b>Lire automatiquement des médias</b> à{' '}
                            <b>Autoriser l'audio et la vidéo</b>
                        </div>
                        <img
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className={classes.expansionPanelHeading}>J'ai Chrome</Typography>
                    </AccordionSummary>
                    <AccordionDetails className={classes.expansionPanelDetails}>
                        ...
                        />
                        <div>
                            Dans le panneau de configuration du site, trouver le paramètre <b>Son</b> et le mettre{' '}
                            <b>Autoriser</b>
                        </div>
                        <img
                            className={classes.permissionsImage}
                ...
                <Accordion>
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography className={classes.expansionPanelHeading}>J'ai un autre navigateur</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography>
                            <Link
                                href={
                                    ...
                                    encodeURI('[Remplacer ici le nom de mon navigateur]') +
                                    '+autoriser+la+lecture+automatique+des+sons+sur+'
                                }
                                target="_blank"
                            >
                                C'est par là
